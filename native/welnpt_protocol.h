 ...
 * where the authenticated WNP2 packet is built and verified.
 */
...
static void welnpt_initialize_host_frame(welnpt_host_frame *frame, uint8_t type) {
...
static int welnpt_valid_host_frame(const welnpt_host_frame *frame) {
